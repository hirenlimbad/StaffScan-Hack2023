...
class employeeManagement:
    ...
    def saveEmployeeForm(self, form):
        """
        ...
        try:
            ...
            insert_query = "INSERT INTO Employee (Name, MobileNumber, EmailID, password, education, position, salary, faceImage) VALUES (%s, %s, %s, %s, %s, %s, %s, %s)"

            # Execute the INSERT statement with the values
            cursor.execute(insert_query, (name, mobile, email, password, education, position, salary, photo1))
    ...
    def showAllEmployees(self):
        ...
        sql_query = "SELECT EmployeeID, Name, MobileNumber, EmailID, faceImage FROM Employee"
